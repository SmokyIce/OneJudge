package com.smokingice.ojbackendquestionservice.controller;
...
import com.smokingice.ojbackendmodel.model.dto.question.*;
...
import com.smokingice.ojbackendmodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User user = userFeignClient.getLoginUser(request);
        if (!userFeignClient.isAdmin(user) && !question.getUserId().equals(user.getId())){
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
    ...
    public BaseResponse<Page<QuestionSubmitVO>> listQuestionByPage(@RequestBody QuestionSubmitQueryRequest questionSubmitQueryRequest,
        ...
        //返回脱敏信息
        final User user = userFeignClient.getLoginUser(request);
